...
expect(UpdateCheck.isNewer("v1.3", than: "1.2"), "1.3 newer than 1.2")
expect(UpdateCheck.isNewer("1.10", than: "1.2"), "numeric 1.10 > 1.2")
expect(!UpdateCheck.isNewer("1.3", than: "1.3"), "equal is not newer")
expect(!UpdateCheck.isNewer("1.2", than: "1.3"), "older is not newer")
expect(!UpdateCheck.isNewer("", than: "1.3"), "empty latest")

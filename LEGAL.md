...
This file is a plain-language note, not legal advice.
...
The code is released under the MIT License (`LICENSE`). That is a well-known open-source license: you may use, copy, modify, and redistribute the software, including commercially, as long as you keep the copyright notice and license text. The software is provided **“AS IS”**, without warranty.
...
Using BitTorrent is legal for content you have the right to share. Using it for content you do not have rights to can be illegal where you live. That is on you, not on this repository.
...
This project was vibe-coded. I do not claim professional expertise in Swift, VPN internals, or macOS security. Documentation in the README describes the intended design. If the software does not work for you, fix it yourself or stop using it.
